...
export const UsersManagement = () => {
  ...
  const getDateLocale = () => {
    return i18n.language === 'ro' ? ro : undefined;
  };

  const { data, isLoading } = useQuery({
    queryKey: ['admin-users', page, size, search, sortField, sortOrder],
    queryFn: () =>
      getUsers({
        page,
        size,
    ...
    <div className='space-y-4'>
      <div className='flex flex-col gap-5'>
        <h1 className='text-3xl font-bold'>
          {t('Pages.Admin.UsersManagement.Title')}
        </h1>
          ...
          <TableHeader>
            <TableRow>
              ...
              <TableHead className='min-w-[80px]'>
                {t('Pages.Admin.UsersManagement.Table.Posts')}
              </TableHead>
              <TableHead className='min-w-[120px]'>
                {t('Pages.Admin.UsersManagement.Table.Friends')}
              </TableHead>
              <TableHead className='min-w-[120px]'>
                {t('Pages.Admin.UsersManagement.Table.Joined')}
              </TableHead>
              <TableHead className='min-w-[100px]'>
                {t('Pages.Admin.UsersManagement.Table.Actions')}
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
                  ...
                  <TableCell>
                    <Dialog>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          <DialogTitle>
                            {t('Pages.Admin.UsersManagement.Dialog.EditUser')}
                          </DialogTitle>
                        </DialogHeader>
                        <div className='space-y-4 py-4'>
                          <div className='space-y-2'>
                            <label>
                              {t(
                                'Pages.Admin.UsersManagement.EditUserDialog.Role'
                              )}
                            </label>
                            <Select
                            ...
                            >
                              <SelectTrigger>
                                <SelectValue
                                  placeholder={t(
                                    'Pages.Admin.UsersManagement.EditUserDialog.SelectRole'
                                  )}
                                />
                              </SelectTrigger>
                              <SelectContent>
